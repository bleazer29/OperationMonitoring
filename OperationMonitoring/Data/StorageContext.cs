...
using OperationMonitoring.Models.StorageModels;
using System;
...
namespace OperationMonitoring.Data
{
    public class StorageContext : DbContext
    {
        ...
        {
            optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Server=IL707;Database=StorageDB;Trusted_Connection=True;");
        }
